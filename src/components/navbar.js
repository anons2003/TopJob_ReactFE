        ...
        <div className="dropdown dropdown-primary" ref={cartDropdownRef}>
            ...
            <div style={{ display: cartitem === true ? "block" : "none" }}>
                <div className={`dropdown-menu dd-menu dropdown-menu-end bg-white rounded shadow border-0 mt-3 show`}>
                    ...
                    {enterpriseRole && (
                        <Link to="/employer-profile" className="dropdown-item fw-medium fs-6">
                            <FiUser className="fea icon-sm me-2 align-middle" />
                            Profile
                        </Link>
                    )}
            ...
            <div className="container">
                ...
                <div id="navigation">
                    <ul className="navigation-menu nav-right nav-light">
                        ...
                        <li
                            className={`${["job-categories", "job-grid-two", "job-list-one", "job-detail-three", "job-apply", "job-post", "career"].includes(manu)
                                ? "active"
                                : ""
                        ...
                        >
                            ...
                            <ul className="submenu">
                                ...
                                <li
                                    className={`${["helpcenter-overview", "helpcenter-faqs", "helpcenter-guides", "helpcenter-support"].includes(manu)
                                        ? "active"
                                        : ""
                                        } has-submenu parent-menu-item`}
                                >
                                    ...
                                    <ul className="submenu">
                                        <li className={manu === "helpcenter-overview" ? "active" : ""}>
