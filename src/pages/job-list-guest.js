                            ...
                            <div className="card bg-white p-4 rounded shadow sticky-bar">
                                ...
                                <div className="mt-4">
                                    ...
                                    {jobTypes.map((jobType) => (
                                        <div className="form-check form-check" key={jobType.jobTypeId}>
                                            <input
                                            ...
                                            />
                                            <label className="form-check-label" htmlFor={`inlineCheckbox${jobType.jobTypeId}`}>
                                                {jobType.jobTypeName}
                                            </label>
                                        </div>
                                    ))}
                                        ...
                                        <div className="col-12" key={index}>
                                            <div className="job-post job-post-list rounded shadow p-4 d-md-flex align-items-center justify-content-between position-relative">
                                                ...
                                                {enterpriseRole ? (
                                                    ...
                                                    <div className="mt-3 mt-md-0">
                                                        <Link to="/candidate-applied-list" className="btn btn-sm btn-primary w-full ms-md-1">Apply now</Link>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
