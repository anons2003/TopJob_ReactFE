                            ...
                            <div className="features-absolute">
                                <div className="d-md-flex justify-content-between align-items-center bg-white shadow rounded p-4">
                                    <div className="d-flex align-items-center">
                                        <img src={enterprise?.avatar_url} className="avatar avatar-md-md rounded shadow p-3 bg-white" alt="" />

                                        <div className="ms-3">
                                            <h5>{enterprise?.enterprise_name}</h5>
                                            <span className="text-muted d-flex align-items-center"><FiMapPin className="fea icon-sm me-1" />{enterprise?.city}, {enterprise?.state}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        {enterpriseRole ? (
                                            <div className="mt-4 mt-md-0">
                                                <Link to="/enterprise-profile-setting" className="btn btn-sm btn-soft-primary">Edit</Link>
                                                <Link to="/job-post" className="btn btn-sm btn-primary me-1">Create Job</Link>
                                            </div>
                                        ) : (
                                            <div className="mt-4 mt-md-0">
                                                <Link to="" className="btn btn-sm btn-primary me-1">Follow</Link>
                                                <Link to="/job-grid-two" className="btn btn-sm btn-soft-primary">See Job</Link>
                                            </div>
                                        )}
                                    </div>
                                </div>
